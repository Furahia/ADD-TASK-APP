...
function App() {
  ...
  function login() {
    ...
    setreRender(!reRender); // HACK: trigger a change in state to rerender the component so we can see the new questions array - we could do better if given enough time :)
  }
   // Logout
   function logout() {
